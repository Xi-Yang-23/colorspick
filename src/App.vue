<template>
  <div class="demo">
    <!-- 纯色板 -->
    <div>
      <colors-pick width="30"
        :swate-colors="['#8B00FF', { color: '#000000', disabled: true }, { color: '#00FF00', disabled: false }, { color: '#00FFFF', disabled: false }]"
        cp-type='swate' square :copy="false" cp-swat-active="love" v-model="colors1" />
      <p> {{ colors1 }}</p>
    </div>
